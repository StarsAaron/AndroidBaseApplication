...
import com.aaron.baselibrary.service.DownloadService;
...
import static com.aaron.baselibrary.utils.ValidateUtils.convertStreamToString;
...
public class FileUtils {
    ...
    public static void init(Context context) {
        KLog.d(TAG, "Root path is " + ROOT_PATH);
...
//            closeIO(is, os);
    ...
    public static String getInternalPath(Context context) {
        KLog.d(TAG, "internal path is " + context.getFilesDir().getPath());
