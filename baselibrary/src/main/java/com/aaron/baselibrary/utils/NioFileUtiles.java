...
public class NioFileUtiles {
    ...
    public static void writeToFileNio(InputStream dataIns, File target) throws IOException {
    ...
    public static void writeToFileIO(InputStream dataIns, File target) throws IOException {
