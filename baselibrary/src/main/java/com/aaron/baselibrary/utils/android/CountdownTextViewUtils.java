 ...
 * 倒计时器
 */
public class CountdownTextViewUtils implements Runnable {
     ...
     */
    public CountdownTextViewUtils(TextView showTextView, String countdownText, int remainingSeconds) {
     ...
     * @param remainingSeconds    倒计时秒数，例如：60，就是从60开始倒计时一直到0结束
     */
    public CountdownTextViewUtils(TextViewGetListener textViewGetListener, String countdownText, int remainingSeconds) {
     ...
     * @param countdownText 倒计时中显示的内容，例如："%s秒后重新获取验证码"，在倒计时的过程中会用剩余描述替换%s
     */
    public CountdownTextViewUtils(TextView showTextView, String countdownText) {
     ...
     * @param countdownText       倒计时中显示的内容，例如："%s秒后重新获取验证码"，在倒计时的过程中会用剩余描述替换%s
     */
    public CountdownTextViewUtils(TextViewGetListener textViewGetListener, String countdownText) {
