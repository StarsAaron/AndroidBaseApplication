...
public class SystemUtils {
    ...
    public static String getSysSdk() {
        ...
        KLog.i("AppSysMgr-->>getSysLanguage", sdkVersion);
        return sdkVersion;
    }
    ...
    public static String getSysLanguage() {
        ...
        KLog.i("AppSysMgr-->>getSysLanguage", language);
        return language;
    }
    ...
    public static String getSysModel() {
        ...
        KLog.i("AppSysMgr-->>getSysModel", model);
        return model;
    }
    ...
    public static String getSysRelease() {
        ...
        KLog.i("AppSysMgr-->>getSysRelease", release);
        return release;
    }
    ...
    public static String getSysSIMSerialNum(Context content) {
        @SuppressLint("MissingPermission") String simSerialNumber = getSysTelephonyManager(content).getSimSerialNumber();
        KLog.i("AppSysMgr-->>getSysSIMSerialNum", simSerialNumber);
    ...
    public static String getSysCPUSerialNum() {
        ...
        try {
            ...
            e.printStackTrace();
            KLog.e("AppSysMgr-->>getSysCPUSerialNum", e.getMessage().toString());
        }
        return cpuSerialNum;
    }
    ...
    private static TelephonyManager getSysTelephonyManager(Context content) {
        ...
        KLog.i("AppSysMgr-->>getSysTelephonyManager", telephonyManager + "");
    ...
    public static String getSysTelephoneSerialNum(Context content) {
        ...
        KLog.i("AppSysMgr-->>getSysTelephoneSerialNum", deviceId + "");
        return deviceId;
    }
    ...
    public static String getSysCarrier(Context content) {
        ...
        KLog.i("AppSysMgr-->>getSysCarrier", moblieType);
        return moblieType;
    }
    ...
    public static Integer getSysPhoneState(Context context) {
        ...
        KLog.i("AppSysMgr-->>getSysPhoneState", callState + "");
        return callState;
    }
    ...
    public static CellLocation getSysPhoneLoaction(Context context) {
        @SuppressLint("MissingPermission") CellLocation cellLocation = getSysTelephonyManager(context).getCellLocation();
        KLog.i("AppSysMgr-->>getSysPhoneLoaction", cellLocation + "");
        return cellLocation;
    }
    ...
    public static String getSysDeviceSoftVersion(Context context) {
        @SuppressLint("MissingPermission") String deviceSoftwareVersion = getSysTelephonyManager(context).getDeviceSoftwareVersion();
        KLog.i("AppSysMgr-->>getSysDeviceSoftVersion", deviceSoftwareVersion + "");
    ...
    public static String getSysPhoneNumber(Context context) {
        @SuppressLint("MissingPermission") String phoneNumber = getSysTelephonyManager(context).getLine1Number();
        KLog.i("AppSysMgr-->>getSysPhoneNumber", phoneNumber + "");
        return phoneNumber;
    }
    ...
    public static String getSysSimCode(Context context) {
        ...
        KLog.i("AppSysMgr-->>getSysSimCode", code + "");
        return code;
    }
    ...
    public static String getSysSimPrivatorName(Context context) {
        ...
        KLog.i("AppSysMgr-->>getSysSimPrivatorName", simOperatorName);
    ...
    public static String getSysUserPhoneId(Context context) {
        ...
        KLog.i("AppSysMgr-->>getSysUserPhoneId", subscriberId);
        return subscriberId;
    }
    ...
    public static DisplayMetrics getSysDisplayMetrics(Activity activity) {
        ...
        KLog.i("AppSysMgr-->>getSysDisplayMetrics", "获取屏幕管理对象为：" + displayMetrics);
    ...
    public static int[] getScreenDispaly(Context context) {
        ...
        KLog.i("AppSysMgr-->>getScreenDispaly-->>width", "获取屏幕宽度为：" + width);
        KLog.i("AppSysMgr-->>getScreenDispaly-->>height", "获取屏幕高度为：" + height);
    ...
    public static Integer getSysScreenWidth(Context context) {
        ...
        KLog.i("AppSysMgr-->>getSysScreenWidth", "获取屏幕宽度为：" + displayMetrics.widthPixels);
    ...
    public static Integer getSysScreenHeight(Context context) {
        ...
        DisplayMetrics displayMetrics = new DisplayMetrics();
        wm.getDefaultDisplay().getMetrics(displayMetrics);
        KLog.i("AppSysMgr-->>getSysScreenHeight", "获取屏幕高度为：" + displayMetrics.heightPixels);
    ...
    public static Integer getSysScreenStatusHeight(Context context) {
        ...
        try {
            ...
            KLog.i("AppSysMgr-->>getSysScreenStatusHeight", "获取屏幕状态栏高度为：" + statusHeight);
        } catch (Exception e) {
            e.printStackTrace();
            KLog.e("AppSysMgr-->>getSysScreenStatusHeight", "获取屏幕状态栏高度失败！" + e.getMessage());
        }
        return statusHeight;
    }
    ...
    public static Integer getSysDefaultThreadPoolSize() {
        ...
        KLog.i("AppSysMgr-->>getSysDefaultThreadPoolSize", availableProcessors + "");
    ...
    public static Integer getSysSampleSize(BitmapFactory.Options options, int minSideLength, int maxNumOfPixels) {
        ...
        KLog.i("AppSysMgr-->>getSysSampleSize", roundedSize + "");
        return roundedSize;
    }
    ...
    public String getSysLocalIpAddress() {
        ...
        try {
            ...
            e.printStackTrace();
            KLog.e("AppSysMgr-->>getSysLocalIpAddress", e.getMessage().toString());
        }
        KLog.i("AppSysMgr-->>getSysLocalIpAddress", hostAddress);
        return hostAddress;
    }
