package com.aaron.baselibrary.utils.apkupdate;
...
import com.aaron.baselibrary.base.BaseApplication;
import com.aaron.baselibrary.utils.KLog;
import com.aaron.baselibrary.utils.android.AppUtils;
...
//        request.setAllowedNetworkTypes(DownloadManager.Request.NETWORK_MOBILE);
        ...
        request.setDestinationInExternalFilesDir(context, Environment.DIRECTORY_DOWNLOADS, AppUtils.getPackageName(BaseApplication.getInstance()));
        KLog.d(TAG, "APK save path is : " + Environment.DIRECTORY_DOWNLOADS);
