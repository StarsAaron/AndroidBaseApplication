 ...
 * 与内部可滑动View的事件冲突问题
 */
public class NoConflictInnerViewPager extends ViewPager {
     ...
     */
    public NoConflictInnerViewPager(Context context) {
        super(context);
     ...
     */
    public NoConflictInnerViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        mGestureDetector = new GestureDetector(new YScrollDetector());
        setFadingEdgeLength(0);
    }
